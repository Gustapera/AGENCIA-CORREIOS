...
function processar() {
    ...
    //&&
    if (nome == '' && txti.value == '') {
        res.innerHTML = '[ERRO] Obrigatorio preencher os dados!'
        return
    }
    ...
    switch(diaSem) {
        case 0:
            ...
            break;
        case 1:
            guiche = 'Guiche A - Setor de Documentação'
            break
        case 2:
            guiche = 'Guiche B - Setor de Contratos'
            break
        case 3:
            guiche = 'Guiche C - Finanças'
            break
        case 4:
            guiche = 'Guiche D - Recursos Humanos'
            break
        case 5:
            guiche = 'Guiche E - Suporte Geral'
            break   
        case 6:
            guiche = 'Fechado - (Sabado)'
            break
        default:
